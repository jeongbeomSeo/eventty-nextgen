package com.eventty.eventtynextgen.auth.authcode.entity;
...
public class AuthCode {
    ...
    @Builder
    private AuthCode(String email, String code, int ttl) {
        this.email = email;
        this.code = code;
     ...
     * @return 엔티티 객체
     */
    public static AuthCode of(String email, String code, int ttl) {
