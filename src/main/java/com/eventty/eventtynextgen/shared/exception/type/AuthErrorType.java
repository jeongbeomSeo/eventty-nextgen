...
public enum AuthErrorType implements ErrorType {
    ...
    INVALID_PASSWORD_LENGTH("INVALID_PASSWORD_LENGTH", "패스워드 형식이 올바르지 않습니다: 패스워드는 8자 이상 16자 이하여야 합니다."),
    INVALID_PHONE_FORMAT("INVALID_PHONE_FORMAT", "핸드폰 형식이 올바르지 않습니다: 핸드폰 번호는 000-0000-0000의 형식이어야 합니다."),
    INVALID_BIRTHDATE_FORMAT("INVALID_BIRTHDATE_FORMAT", "생년월일은 YYYY.MM.DD 혹은 YYYY-MM-DD 형식이어야 합니다."),
