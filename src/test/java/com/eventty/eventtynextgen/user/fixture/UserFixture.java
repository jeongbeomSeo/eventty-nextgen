...
public class UserFixture {
    ...
    public static User createUserWithRoledUser() {
        return User.of("test@naver.com", "password", UserRoleType.USER, "name", "000-0000-0000", "2000-01-01");
    }

    public static User createUserWithRoledHost() {
        return User.of("test@naver.com", "password", UserRoleType.HOST, "name", "000-0000-0000", "2000-01-01");
    }
