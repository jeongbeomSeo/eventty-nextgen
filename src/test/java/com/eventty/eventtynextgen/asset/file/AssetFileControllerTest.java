    ...
    class UploadMultipartFile {
        ...
        void 용량이_512KB인_multipartFile_파일_업로드에_성공한다() throws Exception {
            ...
            resultActions.andExpect(status().isOk())
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.contentType").value("application/zip"));
        ...
        void 용량이_15MB인_multipartFile_파일_업로드에_성공한다() throws Exception {
            ...
            resultActions.andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.fileName").isNotEmpty())
                .andExpect(MockMvcResultMatchers.jsonPath("$.contentType").value("application/yaml"));
        ...
        void 제한_용량이_초과한_MultipartFile_파일_업로드에_실패한다() throws Exception {
            ...
            resultActions.andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$.code").value(AssetErrorType.INVALID_FILE_SIZE.getCode()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.msg").value(AssetErrorType.INVALID_FILE_SIZE.getMsg()));
        }
        ...
        void 이미지_컨텐츠_타입의_MultipartFile_파일_업로드에_실패한다() throws Exception {
            ...
            // then
            resultActions.andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$.code").value(AssetErrorType.INVALID_FILE_CONTENT_TYPE.getCode()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.msg").value(AssetErrorType.INVALID_FILE_CONTENT_TYPE.getMsg()));
        }
        ...
        void 이미지_확장자_타입의_MultipartFile_파일_업로드에_실패한다() throws Exception {
            ...
            MockMultipartFile multipartFile = MultipartConvertHelper.convertMultipartFile("src/test/resources/images/512KB_size_image.jpg", "multipart/form-data");
            String context = "file";
            ...
            // then
            resultActions.andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$.code").value(AssetErrorType.INVALID_FILE_EXTENSION.getCode()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.msg").value(AssetErrorType.INVALID_FILE_EXTENSION.getMsg()));
        }
        ...
        void 이미지_관련_Context가_요청_데이터로_들어온_경우_파일_업로드에_실패한다() throws Exception {
            ...
            // then
            resultActions.andExpect(status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("$.code").value(AssetErrorType.ILLEGAL_ARGUMENT_FILE_CONTEXT.getCode()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.msg").value(AssetErrorType.ILLEGAL_ARGUMENT_FILE_CONTEXT.getMsg()));
        }
